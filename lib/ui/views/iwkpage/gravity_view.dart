...
class GravityView extends StackedView<GravityViewModel> {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildGravityCard(viewModel.logs[index], guid);
              },
            ),
          ),
        ],
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        guid ?? 'd663da48-0c97-452b-97ab-35b1cb531385',
                        style: TextStyle(
                          fontSize: 11,
                ...
                Column(
                  ...
                  children: [
                    Text(
                      _extractDate(logData),
                      style: const TextStyle(fontSize: 11),
                    ),
                    Text(
                      _extractTime(logData),
                      style: const TextStyle(fontSize: 11),
                    ),
                  ],
                ),
  ...
  Map<String, String> _parseWeightData(String logData) {
    ...
    if (weightMatch != null) {
      result['weight'] = weightMatch.group(1) ?? '0.00';
    }
